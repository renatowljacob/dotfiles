...
--  and `:help 'listchars'`
vim.opt.list = true
vim.opt.listchars = { trail = "·", tab = "» ", eol = "↴", leadmultispace = "• " }
...
vim.keymap.set("n", "<leader>dS", vim.diagnostic.show, { desc = "[S]how diagnostics" })

vim.keymap.set("n", "<leader>lf", vim.cmd.Explore, { desc = "Open LF" })
...
-- Center the screen after performing the following motions
