...
static char *colors[SchemeLast][4] = {
	...
	[SchemeNorm]         = { "#C0CAF5", "#1A1B26", "#1A1B26", "norm" },
	[SchemeSel]          = { "#C0CAF5", "#283457", "#283457", "sel" },
	[SchemeTitleNorm]    = { "#C0CAF5", "#1A1B26", "#292E42", "titlenorm" },
	[SchemeTitleSel]     = { "#C0CAF5", "#283457", "#283457", "titlesel" },
	[SchemeWsNorm]       = { "#C0CAF5", "#1A1B26", "#000000", "wsnorm" },
	[SchemeWsVisible]    = { "#C0CAF5", "#283457", "#000000", "wsvis" },
	[SchemeWsSel]        = { "#FF9E64", "#283457", "#000000", "wssel" },
	[SchemeWsOcc]        = { "#9ECE6A", "#1A1B26", "#000000", "wsocc" },
	[SchemeHidNorm]      = { "#C0CAF5", "#1A1B26", "#292E42", "hidnorm" },
	[SchemeHidSel]       = { "#C0CAF5", "#283457", "#283457", "hidsel" },
	[SchemeUrg]          = { "#1A1B26", "#F7768E", "#F7768E", "urg" },
	[SchemeMarked]       = { "#1A1B26", "#BB9AF7", "#BB9AF7", "marked" },
	[SchemeScratchNorm]  = { "#C0CAF5", "#1A1B26", "#292E42", "scratchnorm" },
	[SchemeScratchSel]   = { "#C0CAF5", "#283457", "#283457", "scratchsel" },
	[SchemeFlexActTTB]   = { "#C0CAF5", "#1A1B26", "#292E42", "act.TTB" },
	[SchemeFlexActLTR]   = { "#C0CAF5", "#1A1B26", "#292E42", "act.LTR" },
	[SchemeFlexActMONO]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.MONO" },
	[SchemeFlexActGRID]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.GRID" },
	[SchemeFlexActGRIDC] = { "#C0CAF5", "#1A1B26", "#292E42", "act.GRIDC" },
	[SchemeFlexActGRD1]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.GRD1" },
	[SchemeFlexActGRD2]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.GRD2" },
	[SchemeFlexActGRDM]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.GRDM" },
	[SchemeFlexActHGRD]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.HGRD" },
	[SchemeFlexActDWDL]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.DWDL" },
	[SchemeFlexActDWDLC] = { "#C0CAF5", "#1A1B26", "#292E42", "act.DWDLC" },
	[SchemeFlexActSPRL]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.SPRL" },
	[SchemeFlexActSPRLC] = { "#C0CAF5", "#1A1B26", "#292E42", "act.SPRLC" },
	[SchemeFlexActTTMI]  = { "#C0CAF5", "#1A1B26", "#292E42", "act.TTMI" },
	[SchemeFlexActTTMIC] = { "#C0CAF5", "#1A1B26", "#292E42", "act.TTMIC" },
	[SchemeFlexActFloat] = { "#C0CAF5", "#1A1B26", "#292E42", "act.float" },
	[SchemeFlexInaTTB]   = { "#C0CAF5", "#1A1B26", "#292E42", "norm.TTB" },
	[SchemeFlexInaLTR]   = { "#C0CAF5", "#1A1B26", "#292E42", "norm.LTR" },
	[SchemeFlexInaMONO]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.MONO" },
	[SchemeFlexInaGRID]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.GRID" },
	[SchemeFlexInaGRIDC] = { "#C0CAF5", "#1A1B26", "#292E42", "norm.GRIDC" },
	[SchemeFlexInaGRD1]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.GRD1" },
	[SchemeFlexInaGRD2]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.GRD2" },
	[SchemeFlexInaGRDM]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.GRDM" },
	[SchemeFlexInaHGRD]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.HGRD" },
	[SchemeFlexInaDWDL]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.DWDL" },
	[SchemeFlexInaDWDLC] = { "#C0CAF5", "#1A1B26", "#292E42", "norm.DWDLC" },
	[SchemeFlexInaSPRL]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.SPRL" },
	[SchemeFlexInaSPRLC] = { "#C0CAF5", "#1A1B26", "#292E42", "norm.SPRLC" },
	[SchemeFlexInaTTMI]  = { "#C0CAF5", "#1A1B26", "#292E42", "norm.TTMI" },
	[SchemeFlexInaTTMIC] = { "#C0CAF5", "#1A1B26", "#292E42", "norm.TTMIC" },
	[SchemeFlexInaFloat] = { "#C0CAF5", "#1A1B26", "#292E42", "norm.float" },
	[SchemeFlexSelTTB]   = { "#C0CAF5", "#283457", "#FF9E64", "sel.TTB" },
	[SchemeFlexSelLTR]   = { "#C0CAF5", "#283457", "#FF9E64", "sel.LTR" },
	[SchemeFlexSelMONO]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.MONO" },
	[SchemeFlexSelGRID]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.GRID" },
	[SchemeFlexSelGRIDC] = { "#C0CAF5", "#283457", "#FF9E64", "sel.GRIDC" },
	[SchemeFlexSelGRD1]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.GRD1" },
	[SchemeFlexSelGRD2]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.GRD2" },
	[SchemeFlexSelGRDM]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.GRDM" },
	[SchemeFlexSelHGRD]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.HGRD" },
	[SchemeFlexSelDWDL]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.DWDL" },
	[SchemeFlexSelDWDLC] = { "#C0CAF5", "#283457", "#FF9E64", "sel.DWDLC" },
	[SchemeFlexSelSPRL]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.SPRL" },
	[SchemeFlexSelSPRLC] = { "#C0CAF5", "#283457", "#FF9E64", "sel.SPRLC" },
	[SchemeFlexSelTTMI]  = { "#C0CAF5", "#283457", "#FF9E64", "sel.TTMI" },
	[SchemeFlexSelTTMIC] = { "#C0CAF5", "#283457", "#FF9E64", "sel.TTMIC" },
	[SchemeFlexSelFloat] = { "#C0CAF5", "#283457", "#FF9E64", "sel.float" },
};
...
{ -1,      0,  0,      0,   0,   PwrlNone, BAR_ALIGN_LEFT,        size_powerline,         draw_powerline,         NULL,                    NULL,             "powerline join" },
{ -1,      0,  4,      0,   0,   0,        BAR_ALIGN_LEFT,        size_ltsymbol,          draw_ltsymbol,          click_ltsymbol,          NULL,             "layout" },
{ -1,      0,  0,      0,   0,   PwrlNone, BAR_ALIGN_LEFT,        size_powerline,         draw_powerline,         NULL,                    NULL,             "powerline join" },
...
{  0,      0,  0,      0,   0,   PwrlNone, BAR_ALIGN_RIGHT,       size_powerline,         draw_powerline,         NULL,                    NULL,             "powerline join" },
{ -1,      0,  0,      0,   0,   PwrlNone, BAR_ALIGN_NONE,        size_wintitle_sticky,   draw_wintitle_sticky,   click_wintitle_sticky,   NULL,             "wintitle_sticky" },
{ -1,      0,  0,      0,   0,   PwrlNone, BAR_ALIGN_NONE,        size_flexwintitle,      draw_flexwintitle,      click_flexwintitle,      NULL,             "flexwintitle" },
{ -1,      1,  0,      0,   0,   PwrlNone, BAR_ALIGN_CENTER,      size_pwrl_ifhidfloat,   draw_powerline,         NULL,                    NULL,             "powerline join" },
{ -1,      1,  0,      0,   0,   PwrlNone, BAR_ALIGN_RIGHT_RIGHT, size_wintitle_hidden,   draw_wintitle_hidden,   click_wintitle_hidden,   NULL,             "wintitle_hidden" },
{ -1,      1,  0,      0,   0,   PwrlNone, BAR_ALIGN_LEFT_LEFT,   size_wintitle_floating, draw_wintitle_floating, click_wintitle_floating, NULL,             "wintitle_floating" },
};
