...
static const char *WIN_BG[]   = { "Nsxiv.window.background",   "#1a1b26" };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",   "#c0caf5" };
static const char *MARK_FG[]  = { "Nsxiv.mark.foreground",     "#ff9e64" };
#if HAVE_LIBFONTS
static const char *BAR_BG[]   = { "Nsxiv.bar.background",       NULL };
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",       NULL };
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "JetBrainsMono NF-10" };
